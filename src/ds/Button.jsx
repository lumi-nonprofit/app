...
import { colors, font, leading, palette, radius, type } from "../theme.js";
...
const TEXT_SIZES = { sm: type.sm, md: type.base, lg: type.md };
...
export default function Button({
  ...
  const textStyles = [
    styles.text,
    { fontSize, lineHeight: leading.body(fontSize), color: TEXT_COLORS[variant] || TEXT_COLORS.primary },
    textStyle,
  ];
  const content = [];
  let run = "";
