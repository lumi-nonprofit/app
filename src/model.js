...
export const MOODS = [
  { id: "energie", name: "Energie", axis: "vysoká energie · příjemné",
    color: "var(--sun-400)", soft: "var(--sun-100)", strong: "var(--sun-700)", shape: "circle" },
  { id: "napeti", name: "Napětí", axis: "vysoká energie · nepříjemné",
    color: "var(--lake-500)", soft: "var(--lake-100)", strong: "var(--lake-700)", shape: "diamond" },
  { id: "klid", name: "Klid", axis: "nízká energie · příjemné",
    color: "var(--sage-500)", soft: "var(--sage-100)", strong: "var(--sage-700)", shape: "square" },
  { id: "utlum", name: "Útlum", axis: "nízká energie · nepříjemné",
    color: "var(--clay-500)", soft: "var(--clay-100)", strong: "var(--clay-700)", shape: "half" },
];
