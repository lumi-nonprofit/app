...
import { colors, font, leading, palette, radius } from "../theme.js";
  ...
  return (
    <Screen>
      ...
      <Card style={styles.listCard}>
        <ListItem icon="wind" title="Dech 4-7-8" subtitle="Při napětí a úzkosti" trailing={<Badge tone="accent">3 min</Badge>} onPress={() => {}} />
        <ListItem icon="audio-lines" title="Tichá louka" subtitle="Vedená meditace · čeština" trailing={<Badge tone="accent">10 min</Badge>} onPress={() => {}} />
        <ListItem
          icon="footprints"
...
const styles = StyleSheet.create({
  ...
  eveningHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 6 },
  eveningTitle: { ...font.display(700), fontSize: 17, color: palette.lilac700 },
  eveningText: { ...font.body(400), fontSize: 14.5, lineHeight: leading.body(14.5), color: colors.textBody },
});
