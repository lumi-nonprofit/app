...
describe("aggregateDay", () => {
  ...
  it("převažující stav, průměrná intenzita", () => {
    const agg = aggregateDay([
      { mood: "klid", intensity: 2 },
      { mood: "napeti", intensity: 4 },
      { mood: "klid", intensity: 4 },
    ]);
  ...
  it("remíza → pozdější zápis vyhrává", () => {
    const agg = aggregateDay([
      { mood: "klid", intensity: 3 },
      { mood: "utlum", intensity: 3 },
    ]);
...
describe("buildWeek", () => {
  it("označí dnešek a budoucí dny, záznam přiřadí správnému dni", () => {
    ...
    const entries = [{ date: "2026-06-10", mood: "energie", intensity: 4 }];
  ...
  it("počítá záznamy v aktuálním týdnu", () => {
    ...
    const entries = [
      { date: "2026-06-08", mood: "klid", intensity: 2 },
      { date: "2026-06-01", mood: "klid", intensity: 2 }, // minulý týden — nepočítá se
    ];
